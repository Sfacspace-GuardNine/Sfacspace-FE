...
const Input = ({
  ...
  const defaultStyle =
    "outline-none p-[12px] rounded-[8px] w-full h-[51px] border-[1px] border-neutral-10 bg-transparent bg-transparent text-[#3F3F3F] text-[18px] font-medium focus:border-primary-500 focus:bg-transparent";
